...
public class LAB012_Array12 {
    public static void main(String[] args) {
       ...
       // System.out.println("Enter you Sub1 marks");
     /*   marks[0] = sc.nextFloat();
        System.out.println("Enter you Sub2 marks");
       marks[1] = sc.nextFloat();   */ //This i;;s not the right way of coding instead use loop
